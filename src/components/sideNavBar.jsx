...
export const SideNavBar = ({ onCreateProjectClick }) => {
  return (
      ...
      <div className="flex w-full md:w-full lg:w-full bg-[#100e0c] h-[90%] rounded-tr-[30px] flex-col gap-[30px]">
        ...
        <div className="w-full">
          <button
            ...
            className="rounded-[8px] ml-[30px] bg-[#3C3D37] h-[3rem] w-[60%]  md:w-[60%] lg:w-[60%] text-white text-opacity-60 hover:text-opacity-100"
          >
            + Add Project
          </button>
        </div>
